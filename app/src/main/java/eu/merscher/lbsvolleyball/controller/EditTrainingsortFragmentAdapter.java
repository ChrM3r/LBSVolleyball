...
//
//    EditTrainingsortFragmentAdapter(Context context, Spieler spieler) {
...
//
//        SpielerLoeschenAsyncTask(EditTrainingsortFragmentAdapter context, Spieler spieler) {
...
//            SimpleDateFormat datumsformat = new SimpleDateFormat("dd.MM.yyyy", Locale.GERMANY);
//
//            dataSource.createBuchung(spieler.getS_id(), bu_btr, kto_saldo_alt, kto_saldo_neu, datumsformat.format(kalender.getTime()), null, "X", null);
//
//            return null;
//        }
//
...
//
//
//        SpielerUpdateAsyncTask(EditTrainingsortFragmentAdapter context, Spieler spieler, String name, String vname, String bdate, String userFotoAlsString, String foto, String mail) {
//            activityReference = new WeakReference<>(context);
//            this.spieler = spieler;
//            this.name = name;
//            this.vname = vname;
...
//
//
//            if (EditSpielerActivity.getTrainingsortFotoAlsString() == null && !TextUtils.isEmpty(mail)) {
...
//
//            } else if (EditSpielerActivity.getTrainingsortFotoAlsString() == null && TextUtils.isEmpty(mail)) {
//
...
//
//            } else if (EditSpielerActivity.getTrainingsortFotoAlsString().equals("geloescht") && TextUtils.isEmpty(mail)) {
//
...
//                EditSpielerActivity.setTrainingsortFotoAlsString(Utilities.bildNachSpielerBenennen(activityReference.get().context, updatedSpieler));
//                updatedSpieler = dataSource.updateFotoSpieler(updatedSpieler, EditSpielerActivity.getTrainingsortFotoAlsString());
//                EditSpielerActivity.setTrainingsortFotoAlsString(null);
//
//            } else if (EditSpielerActivity.getTrainingsortFotoAlsString() != null && !TextUtils.isEmpty(mail)) {
//
//                updatedSpieler = dataSource.updateSpieler(spieler.getS_id(), name, vname, bdate, spieler.getTeilnahmen(), EditSpielerActivity.getTrainingsortFotoAlsString(), mail, spieler.getHat_buchung_mm());
//                EditSpielerActivity.setTrainingsortFotoAlsString(Utilities.bildNachSpielerBenennen(activityReference.get().context, updatedSpieler));
//                updatedSpieler = dataSource.updateFotoSpieler(updatedSpieler, EditSpielerActivity.getTrainingsortFotoAlsString());
//                EditSpielerActivity.setTrainingsortFotoAlsString(null);
//
...
//            }
//
//            if (EditSpielerActivity.getTrainingsortFotoAlsString() == null) {
//                ContextWrapper cw = new ContextWrapper(activityReference.get().context);
//
//                File directory = cw.getDir("profilbilder", Context.MODE_PRIVATE);
...
//
//            EditTrainingsortFragmentAdapter activity = activityReference.get();
...
//
//
//        GetNeusteTeamBuchungenUndBereiteVorAsyncTask(EditTrainingsortFragmentAdapter context, Spieler spieler) {
//            activityReference = new WeakReference<>(context);
//            this.spieler = spieler;
//
//        }
...
//
//
//        GetNeusteSpielerBuchungenUndBereiteVorAsyncTask(EditTrainingsortFragmentAdapter context, Spieler spieler) {
//            activityReference = new WeakReference<>(context);
//            this.spieler = spieler;
//
//        }
...
//                    String userFotoAlsString = EditSpielerActivity.getTrainingsortFotoAlsString();
//
...
//                    }
//
//                    new SpielerUpdateAsyncTask(EditTrainingsortFragmentAdapter.this, spieler, name, vname, bdate, userFotoAlsString, foto, mail).execute();
//                    TrainingFragment.setUserGeaendert(true);
//
//                }
//
//            });
...
//                                            new SpielerLoeschenAsyncTask(EditTrainingsortFragmentAdapter.this, spieler).execute();
//                                            onLoeschenClick.onLoeschenClick();
//                                            TrainingFragment.setUserGeaendert(true);
//
...
//
//                                    new GetNeusteTeamBuchungenUndBereiteVorAsyncTask(EditTrainingsortFragmentAdapter.this, spieler).execute();
//                                    new SpielerLoeschenAsyncTask(EditTrainingsortFragmentAdapter.this, spieler).execute();
//                                    onLoeschenClick.onLoeschenClick();
//                                    TrainingFragment.setUserGeaendert(true);
//
...
//                                public void onClick(DialogInterface dialoginterface, int i) {
//
//                                    new GetNeusteSpielerBuchungenUndBereiteVorAsyncTask(EditTrainingsortFragmentAdapter.this, spieler).execute();
//                                    new SpielerLoeschenAsyncTask(EditTrainingsortFragmentAdapter.this, spieler).execute();
//                                    onLoeschenClick.onLoeschenClick();
//                                    TrainingFragment.setUserGeaendert(true);
//
