...
public class Buchung implements Parcelable {
    ...
    public Buchung(long bu_nr, long u_id, Double bu_btr, Double kto_saldo_alt, Double kto_saldo_neu, String bu_date, String ist_training_mm, String ist_manuell_mm, String ist_tunier_mm) {
        this.bu_id = bu_nr;
        this.u_id = u_id;
        this.bu_btr = bu_btr;
    ...
    public void setIst_training_mm(String ist_training_mm) {
        this.ist_training_mm = ist_training_mm;
    }
    ...
    public void setIst_manuell_mm(String ist_manuell_mm) {
        this.ist_manuell_mm = ist_manuell_mm;
    }
    ...
    public void setIst_tunier_mm(String ist_tunier_mm) {
        this.ist_tunier_mm = ist_tunier_mm;
    }
