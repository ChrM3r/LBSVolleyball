...
public class SpielerVerwaltungAdapter extends BaseAdapter implements ListAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        TextView listSpielerGeburtstage = (TextView) view.findViewById(R.id.list_item_string_sub);
        listSpielerGeburtstage.setText(spielerGeburtstage.get(position));

        ImageView spielerBild = (ImageView) view.findViewById(R.id.spielerBild);
